...
export class AppealComponent
  ...
  @ViewChild('stepper') dfaApplicationMainStepper: MatStepper;
  isEditable = true;
  steps: Array<ComponentMetaDataModel> = new Array<ComponentMetaDataModel>();
  showStep = false;
  dfaApplicationMainFolderPath = 'appeal-forms';
  path: string;
  form$: Subscription;
  ...
  constructor(
    ...
    private dfaApplicationMainService: AppealService,
