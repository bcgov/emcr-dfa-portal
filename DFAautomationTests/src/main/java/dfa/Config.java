...
public class Config {
    ...
    public static final String ENVIRONMENT = Constants.DEV_SandboxPub;      //the environment that will be used for the tests Portal
    public static final String ENVIRONMENT_Dynamics = Constants.DEV_SandboxDynamicsPub; //the environment that will be used for the tests RAFT
