...
public class Config {
    ...
    // Env to be run
    public static final String ENVIRONMENT = Constants.TRN_Support;     //the environment that will be used for the tests Portal
    public static final String ENVIRONMENT_Dynamics = Constants.TRN_SupportDynamics; //the environment that will be used for the tests RAFT
