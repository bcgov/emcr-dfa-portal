    ...
    public class ProjectAmendmentMapper : Profile
    {
        public ProjectAmendmentMapper()
        {
            ...
            CreateMap<ProjectAmendment, DFA_ProjectAmendment>()
                ...
                .ForMember(d => d.DFA_AmendmentReceivedDate, opts => opts.MapFrom(s => string.IsNullOrEmpty(s.AmendmentReceivedDate) ? (DateTime?)null : DateTime.Parse(s.AmendmentReceivedDate)))
                .ForMember(d => d.DFA_AmendmentApprovedDate, opts => opts.MapFrom(s => string.IsNullOrEmpty(s.AmendmentApprovedDate) ? (DateTime?)null : DateTime.Parse(s.AmendmentApprovedDate)))
                .ForMember(d => d.DFA_AmendedProjectDeadlineDate, opts => opts.MapFrom(s => string.IsNullOrEmpty(s.AmendedProjectDeadlineDate) ? (DateTime?)null : DateTime.Parse(s.AmendedProjectDeadlineDate)))
                .ForMember(d => d.DFA_Amended18MonthDeadline, opts => opts.MapFrom(s => string.IsNullOrEmpty(s.Amended18MonthDeadline) ? (DateTime?)null : DateTime.Parse(s.Amended18MonthDeadline)))
